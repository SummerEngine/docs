...
Summer is open source with a modular architecture:

### Core Engine
- **Language**: GDScript, C++
- **Repository**: [github.com/SummerEngine/core](https://github.com/SummerEngine/core)
- **License**: MIT

### AI Services
- **Language**: Python, TypeScript
- **Repository**: [github.com/SummerEngine/ai](https://github.com/SummerEngine/ai)
- **License**: Apache 2.0
