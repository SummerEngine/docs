...
<CardGroup cols={2}>
  ...
  >
    Create, upload, organize assets in Studio. Summer imports any asset into your games on command
  </Card>
  <Card
...
Assets from Summer Studio integrate seamlessly with Summer's game development workflow:
