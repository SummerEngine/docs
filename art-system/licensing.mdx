...
The Summer Asset Store provides clear licensing options to help creators share their work while protecting their rights, and to help developers understand how they can use community assets in their projects.
...
```
Art Assets:
- "Fantasy Sword Sprite" by ArtistName (Summer Asset Store)
- "Stone Texture Pack" by CreatorName (Summer Asset Store)
```
...
```markdown
## Assets
This game uses assets from the Summer Asset Store:
...
- Note that it came from Summer Asset Store
