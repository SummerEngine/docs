...
Collections are personalized folders that help you organize and manage your favorite assets from the Summer Studio. Think of them as curated playlists for game assets - you can create collections for specific projects, art styles, or asset types.
...
### Smart Suggestions
Summer Engine's AI uses your collections to make better suggestions:
