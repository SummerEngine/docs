---
title: "How do I migrate from Unity to Summer?"
description: "Rebuild your Unity project in Summer with AI assistance. Use AI to research your project, plan the migration, and rebuild."
icon: "arrow-right"
---

## Migrate from Unity to Summer

You can migrate your Unity project to Summer. The workflow: have the AI use shell and tools to research your existing project, create a migration plan, then rebuild in Summer. Relatively fresh projects can often be done in one pass; larger projects need more planning.
