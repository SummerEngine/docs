...
## Make an Android Game with Summer

Build your game with AI assistance, then export for Android. Summer supports Android export with touch controls and mobile optimization.
...
<Steps>
  ...
  <Step title="Add mobile features">
    Ask Summer: "Add touch controls", "Implement responsive UI for phones and tablets", "Optimize for mobile performance"
  </Step>
</Steps>
