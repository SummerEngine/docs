...
## Make an iOS Game with Summer

Build your game with AI assistance, then export for iPhone and iPad. Summer supports iOS export with full touch and mobile features.
...
<Steps>
  ...
  <Step title="Add mobile features">
    Ask Summer: "Add touch controls for mobile", "Implement responsive UI for different screen sizes", "Add support for device orientation"
  </Step>
</Steps>
