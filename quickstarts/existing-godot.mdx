...
description: "Evaluate an existing upstream-compatible project in Summer Engine, review the first import, and verify version-sensitive integrations."
icon: "folder"
---

## Use Summer Engine with Your Existing Project

Summer Engine uses familiar upstream-derived project formats, but its minimum and recommended
project compatibility ranges remain unmeasured. Work from a committed copy, open it in
Summer Engine, and treat the first import as a compatibility evaluation.
