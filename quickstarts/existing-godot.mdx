---
title: "I have an existing project. How do I add Summer?"
description: "Open your existing project in Summer and get AI assistance immediately. No conversion required."
icon: "folder"
---

## Use Summer with Your Existing Project

Summer works with industry-standard project formats. Open your project and continue working—with AI assistance.

## Step 1: Download and Install Summer
...
<Steps>
  ...
  <Step title="Create your account">
    Open Summer, click "Sign in", and create an account (Google, GitHub, or email)
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Wait for indexing">
    Summer automatically indexes your project (30 seconds to 2 minutes depending on size). The AI learns your scenes, scripts, and assets
  </Step>
...
- **Team workflows** — Team members can use Summer and the standard editor interchangeably
...
<CardGroup cols={2}>
  ...
  <Card title="Project Intelligence" icon="search" href="/ai-tools/rag-search">
    How Summer understands your codebase
  </Card>
