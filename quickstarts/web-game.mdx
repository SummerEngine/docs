...
## Build a Web Game with Summer

Summer excels at web-based game development. Build your game with AI assistance, then export to HTML5/WebAssembly for browser play. No separate web framework needed.
...
<Steps>
  ...
  <Step title="Describe your web game">
    Tell Summer what you want. Examples: "Create a browser game where you catch falling objects" or "Make a simple clicker game with a counter"
  </Step>
</Steps>

## Step 2: Configure for Web Export

When you're ready to export, Summer can help:
