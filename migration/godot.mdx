...
Godot Engine 4.6.1, and Summer follows upstream continuously. That lineage preserves familiar
...
<AccordionGroup>
  ...
  <Accordion icon="question" title="What about version compatibility?">
    The current upstream technical base is 4.6.1 and the planned next base is 4.7.1. Summer
    follows upstream continuously. The project minimum is currently unmeasured, so do not
