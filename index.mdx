...
<CardGroup cols={1}>
  <Card title="How do I publish a game with any AI coding agent?" icon="bot" href="/agent-setup">
    Point Claude Code, Cursor, Codex, or any agent at one prompt: it builds a multiplayer Godot game and submits it to Summercraft for review
  </Card>
