...
<CardGroup cols={1}>
  <Card title="How does Summer Engine work?" icon="sparkles" href="/quickstarts/ai-game-dev">
    Summer works where you work. You can download the desktop app and chat with the agent and it will help you create your game. We also have MCP and CLI, so you can build your game where you prefer to work.
  </Card>
