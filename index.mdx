...
description: "Make games with AI, Cursor, Claude Code, Windsurf, Antigravity, Codex, VS Code, Zed. Summer Engine MCP, CLI, API."
icon: "sparkles"
---
...
One row per solution. Easy to scan top to bottom.
...
<CardGroup cols={1}>
  ...
  <Card title="How do I use the Summer Engine CLI?" icon="terminal" href="/mcp/cli">
    Install, login, create, run. CLI docs and reference.
  </Card>
  <Card title="API Reference" icon="book" href="/api-reference/mcp">
    MCP API, tools reference, and quick links.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="MCP: Build with Cursor, Claude, Windsurf, Antigravity, Codex, VS Code, Zed" icon="plug" href="/mcp">
