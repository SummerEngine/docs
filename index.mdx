---
title: "Summer Engine: Build Games with AI, Compatible with Godot 4"
description: "Describe your game in plain English and Summer Engine writes the code, scenes, and assets. Compatible with Godot 4, connects to your IDE through MCP, CLI, and API."
icon: "sparkles"
---
...
<CardGroup cols={1}>
  ...
  <Card title="How do I use the Summer Engine CLI and MCP?" icon="terminal" href="/mcp/cli">
    CLI lets Claude Code, Cursor, Windsurf install and run Summer Engine. You chat in your IDE; the AI uses MCP tools.
  </Card>
