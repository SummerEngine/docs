...
description: "Make games with AI, Cursor, Claude Code, Windsurf. Summer Engine MCP, CLI, API."
icon: "sparkles"
---
...
<CardGroup cols={2}>
  <Card title="MCP: Build with Cursor, Claude, Windsurf" icon="plug" href="/mcp">
