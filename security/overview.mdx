...
**AWS** - *Sees and stores code data*  
Our primary infrastructure is hosted on AWS. Most servers are in the US, with some latency-critical servers in EU regions (London) for European users.

**Cloudflare** - *Sees code data*  
We use Cloudflare as a reverse proxy to improve performance and security for our API and website.
...
Embeddings of indexed codebases and obfuscated metadata are stored with Turbopuffer on Google Cloud servers in the US. This enables Summer's project intelligence features. You can read more on [Turbopuffer's security page](https://turbopuffer.com/security).
...
**Vercel** - *No code data*  
Hosts our website and documentation. Has no access to code data.
...
- **EU servers**: London (for European users)
- **No Chinese infrastructure**: We do not use any Chinese companies as subprocessors
- **Data residency**: EU users' data can be processed on EU servers where possible
...
- **SOC 2 Type II**: Currently in progress (expected completion Q2 2024)
...
1. **Report immediately**: Email security@summerengine.com
...
### Security Team
- **Email**: security@summerengine.com
- **Response time**: Within 24 hours for security issues
- **Emergency**: For critical security issues, mark subject as "URGENT"

### General Privacy Questions
- **Email**: privacy@summerengine.com
- **Data requests**: Use this email for GDPR/CCPA requests
- **Policy questions**: General questions about our privacy practices
...
This security overview is updated regularly to reflect our current practices and any changes to our infrastructure. Last updated: January 2024.
