...
We built Summer with privacy as the foundation because we understand game developers work on proprietary projects. Your code and game ideas are your competitive advantage. We would never risk that.

**Privacy Mode is enabled by default** for every Summer user. No complex settings, no premium tiers, no compromises. This isn't a feature we charge extra for. It's how Summer works.
...
## How Privacy Works in Summer

### Real Talk About Your Code

**Your code is never used to train AI models. Period.**

We get it. Game developers are paranoid about their ideas being stolen or their code being used to train competing AI. That's why we built Summer with privacy as the default, not an afterthought.
