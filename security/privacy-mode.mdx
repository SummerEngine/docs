...
- **AWS**: Hosts our servers. Your code passes through encrypted, never stored.
- **Cloudflare**: Routes traffic securely. Sees encrypted data only.
...
- **Response time**: We personally respond to all privacy questions within 24 hours
