...
description: "Use Summer Engine and the Summer SDK test runner first; keep bare upstream checks as an advanced compatibility escape hatch."
icon: "flask-conical"
---
...
The test runner ships with the Summer Engine template. The
[/agent-setup](/agent-setup) prompt installs and invokes Summer Engine directly, supplies
local SDK stubs for parsing, and runs import, smoke, banned-API, and pack-content checks.
