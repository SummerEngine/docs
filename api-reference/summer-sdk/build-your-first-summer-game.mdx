...
Every Summer game submitted to Summercraft is multiplayer-native. The default template is
host-authoritative: the server runs the rules, clients render synced state, and a
...
A human reviews every release. Approval publishes the game; the release becomes downloadable
through the authenticated download endpoint. Browser and desktop-shell play of uploaded
Summer games are not live yet.
