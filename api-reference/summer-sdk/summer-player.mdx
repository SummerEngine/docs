---
title: "SummerPlayer"
description: "Game-agnostic player contract: peer identity, synced state, and server-read input. Use SummerCharacter3D for built-in 3D character behavior."
icon: "user"
---

## What Is `SummerPlayer`?

`SummerPlayer` is the minimal platform contract for a connected player.
