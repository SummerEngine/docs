---
title: "MCP Access"
description: "Summer Engine's Model Context Protocol integration is in development"
icon: "plug"
---

## Coming Soon

We're building MCP (Model Context Protocol) access to Summer Engine, enabling seamless integration with Cursor, VS Code, and any other IDE that supports MCP. This will let you access Summer Engine's AI capabilities directly from your favorite development environment.
...
- Access Summer Engine's AI directly from Cursor, VS Code, or any MCP-compatible editor
...
- Summer Engine understands your project structure across different IDEs
- Consistent AI assistance whether you're in Summer Engine or your preferred editor
...
Here are some exciting ways developers will use Summer Engine's MCP integration:

### Multi-IDE Workflows
- **Design in Summer Engine**: Create game scenes and logic in Summer Engine's visual editor
- **Code in Cursor**: Write complex algorithms with Cursor's AI assistance
- **Debug everywhere**: Get Summer Engine's game-specific debugging help in any environment

### Team Collaboration
- **Consistent AI**: Same AI assistant across different team members' preferred IDEs
- **Shared context**: Summer Engine understands your project regardless of which tool you're using
...
- **Asset pipeline**: Integrate Summer Engine's AI into your custom build tools and scripts
