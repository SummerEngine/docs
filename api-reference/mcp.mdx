...
description: "Summer Engine MCP API. Connect Cursor, Claude Code, Windsurf. 51 tools for scene, debug, project, assets, and generation."
icon: "plug"
---
...
- **51 focused tools**: Scene manipulation, debugging, project settings, asset search, asset import, and generation
