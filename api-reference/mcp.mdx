...
description: "Summer Engine MCP API. Connect Cursor, Claude Code, Windsurf. 44 tools for scene, debug, project, assets, and generation."
icon: "plug"
---
...
- **44 focused tools**: Scene manipulation, debugging, project settings, asset search, asset import, and generation
