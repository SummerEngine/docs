...
description: "Summer Engine MCP API. Connect Cursor, Claude Code, Devin Desktop. Tools for scene, debug, project, assets, and generation."
icon: "plug"
---
...
- **Focused tools**: Scene manipulation, debugging, project settings, asset search, asset import, and generation
