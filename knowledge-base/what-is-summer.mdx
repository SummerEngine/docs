...
description: "The AI-native game engine. Build games by describing them in natural language."
icon: "question"
---

## What is Summer Engine?

Summer Engine is **The AI Native Game Engine**. It's not just a game engine with a plugin bolted on. It's a professional engine built from the ground up to be AI-native, where the AI understands your entire project and can modify scenes, code, and assets through natural language commands.
