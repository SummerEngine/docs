...
Summer Engine is based on **Godot 4.6**, which has **full console export support**. However, console publishing is more complex than PC/mobile and requires official approval from platform holders.
...
### Nintendo Switch
- ✅ **Engine support**: Available in Godot 4.6+
