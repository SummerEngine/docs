...
Docs on this site never promise capabilities that are not deployed. The canonical table is
[Product source & platform status](/knowledge-base/source-status). If a page and reality
disagree, trust the API's own error text and mail [founders@summerengine.com](mailto:founders@summerengine.com).
