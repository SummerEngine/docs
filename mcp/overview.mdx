...
description: "How to make games with AI: Cursor, Claude Code, Windsurf, Antigravity, Codex, Gemini, GitHub Copilot, OpenCode, VS Code, Zed. Summer Engine MCP, CLI, and API. 51 tools."
icon: "plug"
---
...
Use Cursor's AI to control Summer Engine. Add the MCP config, open your project, and ask Cursor to add nodes, set properties, import assets, or run the game. The AI has 51 tools: scene manipulation, debugging, project settings, asset library search, and AI generation. All from your IDE.
...
- **51 MCP tools**: Scene (AddNode, SetProp, SaveScene, etc.), Debug and Play (Play, Stop, diagnostics, script and debugger errors), Project (settings, input, import, context), Asset Library (search and import), Generation (image, 3D, audio, video, motion), and Summer Cloud (push, pull, restore, conflicts)
