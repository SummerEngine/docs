...
description: "How to make games with AI: Cursor, Claude Code, Devin Desktop, Antigravity, Codex, Gemini, GitHub Copilot, OpenCode, VS Code, Zed. Summer Engine MCP, CLI, and API. 50+ tools."
icon: "plug"
---
...
- **A full MCP toolset**: Scene (AddNode, SetProp, SaveScene, etc.), Debug and Play (Play, Stop, diagnostics, script and debugger errors, and screenshot the viewport or running game), Project (settings, input, import, context), Asset Library (search and import), Generation (image, 3D, audio, video, motion), and Summer Cloud (push, pull, restore, conflicts)
