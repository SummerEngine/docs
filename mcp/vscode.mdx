---
title: "Godot AI Coding in VS Code with Summer Engine"
description: "Connect Summer Engine's MCP server to VS Code or GitHub Copilot and build games compatible with Godot 4 right inside Microsoft's editor and Copilot's AI agent."
icon: "square-code"
---
