...
description: "Summer Engine MCP tools for scene editing, project files, debugging, visual verification, assets, generation, and Summer Cloud."
icon: "wrench"
---

{/* Do not reintroduce a hardcoded MCP tool count here. This page is slated for generation from the MCP server's own definitions; counts belong in the generator, never in hand-written prose. */}

## Overview

The Summer Engine MCP server exposes tools for **Scene**, **Debug and Play**, **Visual Verification**, **Project**, **Project Files**, **Asset Library**, **Generation**, and **Summer Cloud** workflows.
