---
title: "Build Games in Windsurf with Summer Engine MCP"
description: "Connect Summer Engine's MCP server to Windsurf and build games with Windsurf's AI coding assistant controlling your engine."
icon: "wind"
---
...
Check Windsurf's MCP or AI settings to confirm "summer-engine" appears with 44 tools. Then try a prompt:
