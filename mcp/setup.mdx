...
3. **Check the MCP panel**: In Cursor: Settings > MCP. You should see "summer-engine" with 51 tools.
...
The MCP server exposes 51 tools in six categories:

| Category | Tools | What they do |
|----------|-------|--------------|
| **Scene** | 14 tools | Add nodes, set properties, save/open scenes, connect signals, instantiate prefabs, inspect nodes |
| **Debug and Play** | 9 tools | Run the game, read console output, get diagnostics, script and debugger errors |
