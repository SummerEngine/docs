---
title: "GDExtension"
description: "Summer runs stock Godot 4.6.1 GDExtension binaries unmodified. The ABI is byte-identical to upstream, unsigned third-party libraries load in the shipped macOS editor, and the only real friction is that godot-cpp has no 4.6 branch."
icon: "puzzle"
---
