...
description: "A curated, verified list of community Godot 4 addons that fit Summer's compatibility rules — dialogue, behaviour trees, cameras, terrain, testing and debug tools — plus the reusable test for judging any plugin yourself."
icon: "library"
---
