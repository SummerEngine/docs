...
## Why Documentation Makes Summer Smarter

Imagine trying to build a game without knowing what functions are available, what the current best practices are, or how other developers have solved similar problems. That's what Summer faces without good documentation access.

**Documentation gives Summer the "missing manual" for game development.**

When you ask Summer to help with something, it needs to know:
...
Without documentation access, Summer can only guess. With it, Summer gives you production-ready solutions.
...
## How Summer Uses Documentation

Summer has access to a vast library of game development knowledge that it taps into when helping you. Think of it as having an expert researcher who can instantly find the right information.

### Summer's Research Tools

**Godot's Official Documentation**
Summer can read and understand Godot's complete documentation. When you ask about something specific, Summer doesn't guess - it looks up the exact API, properties, and examples.

**Community Knowledge Base**
Summer has access to curated examples of common Godot workflows:
...
Summer can search current tutorials, forums, and resources:
```
"Find the latest Godot 4.5 shader examples for water effects"
...
Summer also learns from how you write code, what patterns you use, and how you structure your game. It combines this with external knowledge to give you personalized advice.
