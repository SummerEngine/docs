...
<AccordionGroup>
  ...
  <Accordion icon="download" title="Import Assets">
    **What it does**: Imports 3D models, textures, and audio from the asset store into your project
    ...
    **How it works**:
    - AI searches the asset store (25k+ assets) by semantic and keyword
