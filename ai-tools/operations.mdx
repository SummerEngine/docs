...
Every change Summer Engine makes can be undone with Ctrl+Z. If something doesn't work as expected, you can instantly revert it and try a different approach.
