...
The agent can **spawn subagents**: specialized assistants that run in their own context, in parallel when needed, and return summarized results. See [Subagents](/ai-tools/subagents) for how they work and when to use them.
