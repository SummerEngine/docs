...
every submission before it goes live. There is no auto-publish.
...
4. Playing uploaded Summer games in the browser or desktop shell, and hosted game servers,
   are not live yet — publishing today means entering the catalog pipeline, not instant
   playability. Do not claim otherwise.
